const handleAdminPanelChange = (name, state, setState) => (e) => {
...
const AdminPanel = ({ index, meal, auth, state, setState }) =>
  auth.role === 'admin' && (
    <div className="form-group">
      ...
      <div className="pb-2">
        <input
          ...
          onChange={handleAdminPanelChange('studentName', state, setState)}
      ...
      <div className="pb-2">
        <select
          ...
          onChange={handleAdminPanelChange('schoolName', state, setState)}
        >
      ...
      <div className="pb-2">
        <select
          ...
          onChange={handleAdminPanelChange('group', state, setState)}
        >
      ...
      {meal.group != 'distance-learning' && (
        <select
          ...
          className="form-control"
          placeholder="Cohort"
          onChange={handleAdminPanelChange('teacher', state, setState)}
        >
