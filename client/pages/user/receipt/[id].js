    ...
    return <>
      {
        ...
        <div
          key={242}
          className={oldLink && oldLink.orderStatus === true ||
        ...
        >
                    ...
                    <>
                      <h5 className="">
                        <b>
                          {k.student === undefined
                            ? 'user deleted'
                            : oldLink.postedBy.students.filter((student) => student._id.includes(k.student)
                            ) && k.studentName}
                          :
                        </b>
                        <br></br>
          ...
          <div className={" pb-3 pt-3 " + styles.noPrint}>
            ...
            <span>&nbsp;&nbsp;</span>
            {<button type="button" className="btn btn-sm btn-outline-dark text  print" onClick={e => window.print()}>
